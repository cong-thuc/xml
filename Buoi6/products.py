...
def sync_data_to_db(xml_doc, db_connection):
    ...
    try:
        ...
        # Dùng XPath để lấy dữ liệu từ categories 
        ...
        # Dùng XPath để lấy dữ liệu từ products
...
def main():
    ...
    try:
        ...
        # 5. Dùng XPath lấy dữ liệu và Insert/Update vào MySQL
